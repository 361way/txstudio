---
name: vodstudio-local-backend
description: VodStudio 本地单用户 Go 后端，统一提供 SQLite 持久化、API 凭证加密、VOD 代签、代理、缓存和静态前端托管。
---
...
- `/api/agent/chat`：智能 Agent 文本分析代理（通过 `VODSTUDIO_AGENT_API_KEY` 注入密钥）
